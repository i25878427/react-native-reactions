...
const useEmojiItem = (props) => {
    ...
    const scaled = currentPosition > xValue && currentPosition < xValue + containerWidth;
    ...
    const onLayout = (e) => {
        setTimeout(() => {
            (childRef === null || childRef === void 0 ? void 0 : childRef.current) &&
                (childRef === null || childRef === void 0 ? void 0 : childRef.current.measureInWindow((x, y, width) => {
                    setXValue(x);
